  ...
  return (
    <RadixDialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content className="panel fixed top-1/2 left-1/2 z-50 w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 p-6 motion-safe:data-[state=open]:animate-[surface-in_150ms_ease-out] motion-safe:data-[state=closed]:animate-[surface-out_150ms_ease-in]">
